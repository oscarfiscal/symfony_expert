...
class TagController extends AbstractController
{
    ...
    #[ParamConverter('/new-tag-ajax', name: 'new_tag_ajax')]
    #[ ('tag', converter: 'tag_converter')]
    public function newTagAjax( Request $request, TagRepository $tagRepository): Response
    {
        $created = false;
       if($request->isXmlHttpRequest()) {
        $tag = new Tag();
