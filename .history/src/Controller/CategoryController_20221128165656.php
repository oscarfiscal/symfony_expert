...
class CategoryController extends AbstractController
{
    ...
    public function search(string $search, int $page, MarkerRepository $markerRepository, CategoryRepository $categoryRepository, Request $request): Response
    {
    ...
    public function favorite(int $page, MarkerRepository $markerRepository): Response
    {
