...
class CategoryController extends AbstractController
{
    ...
    #[Route('/{category}/{page}', name: 'app_category', defaults: ["category" => "", "page" => 1], requirements: ["page" => "\d+"])]
    ...
    {
        $elementsPeerPage = self::ELEMENTS_PER_PAGE;
        if(!empty($category)){
            ...
            $markers = $markerRepository->filterCategory($category, $page,$elementsPeerPage);
           

        }else{
            $markers = $markerRepository->filterAll($page,$elementsPeerPage);
        }
        ...
        return $this->render('index/index.html.twig', [
            ...
            'elements_per_page' =>$elementsPeerPage,
        ]);
    }
