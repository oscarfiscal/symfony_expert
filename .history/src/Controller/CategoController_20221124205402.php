...
class CategoController extends AbstractController
{
    ...
    public function new(CategoryRepository $categoryRepository, EntityManagerInterface $entityManager,Request $request): Response
    {
        ...
        if($this->isCsrfTokenValid('category',$request->request->get('_token'))){
            ...
            if($name){
                ...
                $this->addFlash('error','El nombre de la categoria no puede estar vacio');
            }
