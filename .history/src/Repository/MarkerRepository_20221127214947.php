...
class MarkerRepository extends ServiceEntityRepository
{
    ...
    public function filterName($name)
    {
        return $this->createQueryBuilder('m')
            ...
            ->setParameter('name',  requires that you provide a value for the "$search" argument. Either the argument is nullable and no null value has been provided, no default value has been provided or because there is a non optional argument after this one.)
            ->getQuery()
            ->getResult();
        ;
    }
